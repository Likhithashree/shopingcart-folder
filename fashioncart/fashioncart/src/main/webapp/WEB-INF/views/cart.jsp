...
<body>
	...
	<div class="container" style="align:center; margin: 20px 100px 0px 550px">
			...
			<div class="panel panel-warning" >
				<div class="panel-heading">
					...
					<div class="row">
							...
							<div class="col-xs-6">
								<a href="home" type="button" class="btn btn-primary btn-sm btn-success">
				...
				<c:forEach items="${cartList}" var="cart">
					<div class="row">
						...
						<div class="col-xs-3">
							<h4  class="product-name"><strong>${cart.p_name}</strong></h4><h4><small>Products description</small></h4>
						</div>
						<div class="col-xs-6">
