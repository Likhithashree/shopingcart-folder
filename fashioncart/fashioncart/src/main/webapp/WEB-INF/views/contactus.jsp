    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-4 col-md-8">
                ...
                <h1 class="h1" style="color:#EEE8AA;display:inline"> Contact us</h1>
                 <h1><small style="color:#EEE8AA">Feel free to contact us</small></h1>
            </div>
        </div>
    </div>
</div>
<div class="container">
    <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="subject" name="subject" class="form-control" required="required">
                                ...
                                <option value="product">Other Complaints</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-md-4" style="color:#000000">
            ...
            <address>
                <strong style="color:#000000"></strong><br>
               MALLESHWARAM<br>
                <abbr title="Phone">
                    P:</abbr>
                +91 9743925129
            ...
            <address>
                <strong>LIKHITHASHREE.R</strong><br>
                <a href="mailto:#">likhithashreer@gmail.com</a>
            </address>
            </form>
        </div>
    </div>
