...
<!--       <li class="active"><a href="#">Home</a></li> -->
      ...
      <li><a style="color:#F5F5DC" href="contactus">CONTACT US</a></li> 
    </ul>
...
<%--       <li><a  href="<c:url value="/myCart" />"><span class="glyphicon glyphicon-shopping-cart"></span> CART</a>${cartSize}</li> --%>
      ...
      <c:if test="${pageContext.request.userPrincipal.name  == ''}">
       ...
       <li><a  style="color:#F5F5DC;margin:0px 0px 0px 0px" href="<c:url value="register" />"><span class="glyphicon glyphicon-user"></span> SignUp</a></li>
